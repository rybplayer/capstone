...
<img class="report-figure" src="/src/pages/figures/equality_matrix.svg" alt="An example communication matrix for the equality function." />
...
In this report, we study the problem of finding a path in a graph whose vertices may be owned by various players. This is an abstract version of the motivating problem in the section [Motivating Communication Complexity](/introduction#ex-motivating-problem), which we choose to work in so that any bounds we prove will be applicable to a wide range of problems.
...
<img class="report-figure" src="/src/pages/figures/valid_path.svg" alt="Example where a valid path exists for TRAV2" />

<img class="report-figure" src="/src/pages/figures/no_path.svg" alt="Example where no valid path exists for TRAV2" />
