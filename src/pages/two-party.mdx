...
import equalityGadget from './figures/equality_gadget.svg?url'
import equalityGadgetChain from './figures/eq_chain.svg?url'
import disjointGadget from './figures/disj_gadget.svg?url'
import disjointGadgetChain from './figures/disjoint_chain.svg?url'
import ctravGadget from './figures/connected_embedding.svg?url'
...
<img class="report-figure" src={equalityGadget} alt="Equality gadget for a single index" />
...
<img class="report-figure" src={equalityGadgetChain} alt="Chain of equality gadgets" />
...
<img class="report-figure" src={disjointGadget} alt="Disjointness gadget for a single index" />
...
<img class="report-figure" src={disjointGadgetChain} alt="Chain of disjointness gadgets" />
...
<img class="report-figure" src={ctravGadget} alt="Connected-subgraph gadget for CTRAV2" />
